...
/**
 * Loading screen shown after market + style selections.
 * Visualizes the system being personalized.
 */
export default function SlideBuildingLoader(_props: SlideProps) {
    ...
    <div className="flex flex-col items-center gap-8">
      <div className="relative h-[240px] w-full">
        ...
        <svg viewBox="0 0 320 240" className="absolute inset-0 h-full w-full">
          <defs>
            <linearGradient id="bl-line" x1="0" y1="0" x2="1" y2="1">
              <stop offset="0%" stopColor="#6C5CE7" />
              <stop offset="100%" stopColor="#00C6FF" />
            </linearGradient>
          </defs>
          {[
            { d: "M60 50 L 160 120", del: 0 },
            { d: "M260 50 L 160 120", del: 0.2 },
            { d: "M160 120 L 80 200", del: 0.4 },
            { d: "M160 120 L 240 200", del: 0.6 },
          ].map((p, i) => (
            <motion.path
              key={i}
              d={p.d}
        ...
        {[
          { x: 60, y: 50, size: 11, color: "#A29BFE", del: 0 },
          { x: 260, y: 50, size: 13, color: "#00C6FF", del: 0.3 },
          { x: 80, y: 200, size: 10, color: "#FF7AF5", del: 0.6 },
          { x: 240, y: 200, size: 12, color: "#6C5CE7", del: 0.8 },
        ].map((n, i) => (
          <motion.div
            key={i}
